...
{
    public class ProductHistoryApiController : ApiController
    {
        ...
        // GET: api/UserLists/5
        [HttpGet]
        public HttpResponseMessage GetOfMonthYear(int productId, int month, int year)
        {
            List<ProductsListHistoryModel> _UserProductsListHistoryList = Managers.ProductHistoryManager.GetOfMonthYear(productId, month, year);
